      ...
      <div className="mx-auto flex min-h-[80vh] max-w-6xl items-center">
        <div className="grid w-full gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-900/80 p-8 shadow-2xl backdrop-blur">
            ...
            {/* 🔥 DEMO CREDENTIALS */}
            <div className="mt-6 rounded-2xl border border-cyan-500/20 bg-cyan-500/5 p-4 text-xs text-slate-300">
              <p className="mb-2 text-cyan-300 font-medium tracking-wide">
                Demo Credentials
              </p>
